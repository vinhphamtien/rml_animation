 ...
 */
public class FixedParticleSystem {
    ...
    private static class ParticleTimerTask extends TimerTask {
        ...
        private final WeakReference<FixedParticleSystem> mPs;

        public ParticleTimerTask(FixedParticleSystem ps) {
            mPs = new WeakReference<FixedParticleSystem>(ps);
        }

        @Override
        public void run() {
            if(mPs.get() != null) {
                FixedParticleSystem ps = mPs.get();
    ...
    private FixedParticleSystem(ViewGroup parentView, int maxParticles, long timeToLive) {
        mRandom = new Random();
     ...
     */
    public FixedParticleSystem(ViewGroup parentView, int maxParticles, Drawable drawable, long timeToLive) {
     ...
     * @param timeToLive The time to live for the particles
     */
    public FixedParticleSystem(Activity a, int maxParticles, int drawableRedId, long timeToLive) {
     ...
     */
    public FixedParticleSystem(Activity a, int maxParticles, int drawableRedId, long timeToLive, int parentViewId) {
     ...
     * @param timeToLive The time to live for the particles
     */
    public FixedParticleSystem(Activity a, int maxParticles, Drawable drawable, long timeToLive) {
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    public FixedParticleSystem(Activity a, int maxParticles, Drawable drawable, long timeToLive, int parentViewId) {
     ...
     * @param timeToLive The time to live for the particles
     */
    public FixedParticleSystem(Activity a, int maxParticles, Bitmap bitmap, long timeToLive) {
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    public FixedParticleSystem(Activity a, int maxParticles, Bitmap bitmap, long timeToLive, int parentViewId) {
     ...
     * @param timeToLive The time to live for the particles
     */
    public FixedParticleSystem(Activity a, int maxParticles, AnimationDrawable animation, long timeToLive) {
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    public FixedParticleSystem(Activity a, int maxParticles, AnimationDrawable animation, long timeToLive, int parentViewId) {
        this((ViewGroup) a.findViewById(parentViewId), maxParticles, timeToLive);
        // Create the particles
        for (int i=0; i<mMaxParticles; i++) {
            mParticles.add (new AnimatedParticle (animation));
     ...
     */
    public FixedParticleSystem addModifier(ParticleModifier modifier) {
        mModifiers.add(modifier);
        return this;
    }

    public FixedParticleSystem setSpeedRange(float speedMin, float speedMax) {
     ...
     * @return This.
     */
    public FixedParticleSystem setSpeedModuleAndAngleRange(float speedMin, float speedMax, int minAngle, int maxAngle) {
     ...
     * @return This.
     */
    public FixedParticleSystem setSpeedByComponentsRange(float speedMinX, float speedMaxX, float speedMinY, float speedMaxY) {
     ...
     * @return This.
     */
    public FixedParticleSystem setInitialRotationRange(int minAngle, int maxAngle) {
     ...
     * @return This.
     */
    public FixedParticleSystem setScaleRange(float minScale, float maxScale) {
     ...
     * @return This.
     */
    public FixedParticleSystem setRotationSpeed(float rotationSpeed) {
     ...
     * @return This.
     */
    public FixedParticleSystem setRotationSpeedRange(float minRotationSpeed, float maxRotationSpeed) {
     ...
     * @return
     */
    public FixedParticleSystem setAccelerationModuleAndAndAngleRange(float minAcceleration, float maxAcceleration, int minAngle, int maxAngle) {
     ...
     * @return This.
     */
    public FixedParticleSystem setAcceleration(float acceleration, int angle) {
     ...
     * @return This.
     */
    public FixedParticleSystem setParentViewGroup(ViewGroup viewGroup) {
    ...
    public FixedParticleSystem setStartTime(long time) {
        mCurrentTime = time;
        return this;
    }
     ...
     */
    public FixedParticleSystem setFadeOut(long milisecondsBeforeEnd, Interpolator interpolator) {
     ...
     */
    public FixedParticleSystem setFadeOut(long duration) {
